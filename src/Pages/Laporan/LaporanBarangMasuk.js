...
const LaporanBarangMasuk = () => {
  const [data] = useState([
    { tanggal: '2024-01-01', project: 'Project Alpha', type: 'Component', partNumber: 'RLSGD2510VIC', manufacture: 'YAGEO', barangMasuk: 300 },
    { tanggal: '2024-01-02', project: 'Project Beta', type: 'Component', partNumber: 'MUP-C7802I-1', manufacture: 'Samsung', barangMasuk: 200 },
    { tanggal: '2024-01-03', project: 'Project Gamma', type: 'Component', partNumber: 'K5-1305A-03', manufacture: 'Panasonic', barangMasuk: 500 },
    ...
    <div className="p-4 sm:p-6 md:p-8 bg-slate-50 min-h-screen animate-fade-in-down">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-4 sm:mb-0">Laporan Barang Masuk</h1>
          ...
          <table className="min-w-full">
            <thead className="bg-slate-100">
              <tr>
                ...
                <th className="text-right py-3 px-4 text-sm font-bold text-slate-600">Barang Masuk</th>
              </tr>
            </thead>
            <tbody className="text-gray-700 text-sm">
              {filteredData.map((item, index) => (
                <tr key={index} className="border-b border-gray-200 odd:bg-white even:bg-slate-50 hover:bg-red-50">
                  ...
                  <td className="py-4 px-4 text-right font-medium text-green-600">{item.barangMasuk.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </table>
