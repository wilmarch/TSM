...
const LaporanBarangMasuk = () => {
    const [data] = useState([
        { tanggal: '1 January 2024', project: 'Project Alpha', type: 'Component', partNumber: 'RLSGD2510VIC', manufacture: 'YAGEO', barangMasuk: 300 },
        { tanggal: '2 January 2024', project: 'Project Beta', type: 'Component', partNumber: 'MUP-C7802I-1', manufacture: 'Samsung Electro-Mechanics', barangMasuk: 200 },
                ...
                <table className="min-w-full bg-white shadow-md rounded-lg">
                    <thead className="bg-red-500 text-white">
                        <tr>
                            ...
                            <th className="px-4 py-3 uppercase font-semibold text-sm text-center">Barang Masuk</th>
                        </tr>
                    </thead>
                    <tbody className="text-gray-700">
                        {data.slice(0, itemsToShow).map((item, index) => (
                            <tr key={index} className="hover:bg-gray-100">
                                ...
                                <td className="px-4 py-3 text-center">{item.barangMasuk}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
