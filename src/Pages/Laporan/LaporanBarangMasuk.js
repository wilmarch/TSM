...
const LaporanBarangMasuk = () => {
    const [data] = useState([
        { tanggal: '1 January 2024', type: 'Component', partNumber: 'RLSGD2510VIC', manufacture: 'YAGEO', barangMasuk: 300 },
        { tanggal: '2 January 2024', type: 'Component', partNumber: 'MUP-C7802I-1', manufacture: 'Samsung Electro-Mechanics', barangMasuk: 200 },
                    ...
                    <tbody className="text-gray-700">
                        {data.slice(0, itemsToShow).map((item, index) => (
                            <tr key={index} className="hover:bg-gray-100">
                                ...
                                <td className="px-4 py-3">{item.barangMasuk}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
